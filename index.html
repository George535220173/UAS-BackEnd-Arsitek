...
<body>
    ...
    <section class="feature-section">
        <div class="feature-image-container">
            <img src="images/puppy-ai.jpg" alt="Feature Image">
        </div>
    ...
    <section class="portfolio-section">
        ...
        <div class="portfolio-container">
            <div class="portfolio-item" data-category="app">
                <img src="images/husky.jpg" alt="Portfolio Item">
            </div>
            <div class="portfolio-item" data-category="card">
                <img src="images/puppy-ai.jpg" alt="Portfolio Item">
            </div>
    ...
    <section class="rating-carousel">
        <div class="carousel-container">
            <div class="rating-item">
                <img src="images/husky.jpg" alt="Customer Avatar" class="customer-avatar">
            ...
            <div class="rating-item">
                <img src="images/puppy-ai.jpg" alt="Customer Avatar" class="customer-avatar">
