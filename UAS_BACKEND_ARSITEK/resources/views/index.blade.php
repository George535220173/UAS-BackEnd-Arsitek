    ...
    <section class="info-section">
        ...
        <div class="sidebar">
            ...
            <div class="article-snippet">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a neque quis sem volutpat hendrerit...
                </p>
            </div>
            <div class="article-snippet">
                <h4>Article Title 2</h4>
                <p>Nulla facilisi. Vivamus dictum sapien sed odio euismod, nec scelerisque felis interdum...</p>
            </div>
            <div class="article-snippet">
                <h4>Article Title 3</h4>
                <p>Curabitur vel orci nec metus varius tincidunt sit amet at libero. Integer non lorem sed lorem
                    aliquet...</p>
            </div>
        </div>
    </section>
    ...
    <section class="rating-carousel">
        <div class="carousel-container">
            <div class="rating-item">
                ...
                <p class="rating-text">Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit
