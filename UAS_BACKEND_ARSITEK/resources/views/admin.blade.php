                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="admin-form-group">
                                                    <label for="main_category_edit{{ $project->id }}">Main Category</label>
                                                ...
                                                <div class="admin-form-group">
                                                    <label for="sub_category_select{{ $project->id }}">Category</label>
                ...
                <table class="admin-table">
                    ...
                    <tbody>
                        @foreach($articles as $article)
                            <tr>
                                <td class="admin-td">{{ $loop->iteration }}</td>
                                <td class="admin-td"><img src="{{ asset('img/Article/' . basename($article->thumbnail)) }}" alt="Thumbnail Image" width="100"></td>
