                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.projects.update', $project->id) }}" method="POST"
                                            ...
                                            <div class="admin-form-group">
                                                ...
                                                <input type="text" id="project_name{{ $project->id }}" name="project_name"
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.articles.update', $article->id) }}" method="POST"
                                            ...
                                            <div class="admin-form-group">
                                                ...
                                                <input type="text" id="article_title{{ $article->id }}" name="article_title"
                                            ...
                                            <div class="admin-form-group">
                                                ...
                                                <input type="text" id="article_author{{ $article->id }}"
                                                    name="article_author" value="{{ $article->article_author }}" required>
                                            </div>
                                            <div class="admin-form-group">
                                            ...
                                            <div class="admin-form-group">
                                                ...
                                                <input type="text" id="article_link{{ $article->id }}" name="article_link"
                                                    value="{{ $article->article_link }}" required>
                                            </div>
